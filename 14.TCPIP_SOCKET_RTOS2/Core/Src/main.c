...
#include "lwip/udp.h"		// ADD_JUHEE
#include "udp_echoserver.h"  // ADD_SIKWON
...
/* USER CODE BEGIN 4 */
ip_addr_t addr1; 			// ADD_JUHEE
struct phuf *p1;			// ADD send buffer
char temp_str[40];		// ADD temp buffer
struct udp_pcb *upcb1;		// ADD udp control  block
